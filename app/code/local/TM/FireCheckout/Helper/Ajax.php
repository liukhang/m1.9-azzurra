...
class TM_FireCheckout_Helper_Ajax// extends Mage_Core_Helper_Abstract
{
    ...
    public function getIsAgreementsDependsOn($section)
    {
        return $this->getIsSectionDependsOn('agreements', $section);
    }

    public function getIsDiscountDependsOn($section)
    {
        return $this->getIsSectionDependsOn('discount', $section);
    }
}
