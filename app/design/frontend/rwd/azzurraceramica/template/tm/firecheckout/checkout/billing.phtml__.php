...
<div id="billing-address" class="firecheckout-section">
    ...
    <div class="block-content">
        ...
        <li id="billing-new-address-form"<?php if ($this->customerHasAddresses()): ?> style="display:none;"<?php endif; ?>>
            <div class="radiocustom_checkout">
                <div class="radiocustom-left">
                    <label class="checkbox_x checkbox_x--radio"><input type="radio" name="billingradiocustom" class="radiocustom1" value="1" onclick="checkradio(1)"><div class="checkbox_x__indicator"></div></label>
                    <label><?php echo $this->__('Privato') ?></label>
                </div>
                <div class="radiocustom-right">
                    <label class="checkbox_x checkbox_x--radio"><input type="radio" name="billingradiocustom" id="radiocustom-azienda" class="radiocustom2" value="2" onclick="checkradio(2)"><div class="checkbox_x__indicator"></div></label>
                    <label><?php echo $this->__('Azienda') ?></label>
                </div>
            </div>
            <fieldset>
                ...
                <ul>
                                ...
                                <?php else : ?>
                                    ...
                                    <?php else: ?>
                                        <label for="<?php echo $_prefix ?>:<?php echo $field ?>"
                                            ...
                                            ><?php if ($required || $field=='company' || $field=='vat_id'): ?><em>*</em><?php endif; ?><?php echo $this->__($fields[$field]['label']) ?>
                                        </label>
                                        <div class="input-box">
                    ...
                    <li class="wide">
                        <div class="input-box">
                            <div class="input-box">
                                <input type="text" placeholder="<?php echo $this->__('Codice Fiscale') ?>" name="billing[tax_number]" value="<?php echo $this->htmlEscape($this->getAddress()->getTaxNumber()) ?>" title="<?php echo $this->__('Codice Fiscale') ?>" id="billing:tax_number" class="input-text required-entry codice_fiscale" />
                            </div>
                        </div>
                    </li>
                     <li class="wide">
                        <textarea id="atelier-checkout-note" class="atelier-checkout-note" name="post-note" cols="" rows="" tabindex="" data-min-length="" placeholder="<?php echo __('Note') ?>"></textarea>
                    </li>
                    <p class="text_small" style="margin: 10px 0">* I campi contrassegnati sono obbligatori</p>
    ...
    //]]>
        ...
        */
        ...
        jQuery('.codice_fiscale').parent().parent().show();
        ...
        function checkradio(ev){
            if(jQuery('.radiocustom'+ev).is(':checked')) {
                if(ev==1){
                    ...
                    jQuery('.vat_id').parent().parent().hide();
                    jQuery('.codice_fiscale').addClass('required-entry');
                    jQuery('.codice_fiscale').parent().parent().show();
                    jQuery('.companynew').parent().parent().hide();
                }else{
                    ...
                    jQuery('.codice_fiscale').removeClass('required-entry');
                    jQuery('.codice_fiscale').parent().parent().hide();
